...
# was:	ori	_plus_R_7_, 0, 2
	add	$10, $2, $10
# was:	add	_mult_L_4_, _plus_L_6_, _plus_R_7_
# 	ori	_minus_L_8_,_param_y_2_,0
	ori	$11, $0, 2
# was:	ori	_minus_R_9_, 0, 2
	sub	$11, $3, $11
# was:	sub	_mult_R_5_, _minus_L_8_, _minus_R_9_
	mul	$2, $10, $11
# was:	mul	_fres_3_, _mult_L_4_, _mult_R_5_
# 	ori	2,_fres_3_,0
	addi	$29, $29, 8
	lw	$31, -4($29)
	jr	$31
...
# was:	ori	_plus_R_18_, 0, 2
	add	$11, $12, $11
# was:	add	_mult_L_15_, _plus_L_17_, _plus_R_18_
# 	ori	_minus_L_19_,_letBind_14_,0
	ori	$12, $0, 2
# was:	ori	_minus_R_20_, 0, 2
	sub	$10, $10, $12
# was:	sub	_mult_R_16_, _minus_L_19_, _minus_R_20_
	mul	$16, $11, $10
# was:	mul	_letBind_12_, _mult_L_15_, _mult_R_16_
