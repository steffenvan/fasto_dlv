...
# was:	sw	_tmp_reg_13_, 0(_addr_reg_12_)
	addi	$11, $11, 4
# was:	addi	_addr_reg_12_, _addr_reg_12_, 4
# 	ori	_inp_reg_17_,_letBind_10_,0
	ori	$2, $0, 0
# was:	ori	_acc_reg_20_, 0, 0
	lw	$16, 0($17)
# was:	lw	_size_reg_18_, 0(_inp_reg_17_)
	addi	$17, $17, 4
# was:	addi	_inp_reg_17_, _inp_reg_17_, 4
	ori	$18, $28, 0
# was:	ori	_letBind_15_, 28, 0
	sll	$10, $16, 2
# was:	sll	_tmp_24_, _size_reg_18_, 2
	addi	$10, $10, 4
# was:	addi	_tmp_24_, _tmp_24_, 4
	add	$28, $28, $10
# was:	add	28, 28, _tmp_24_
	sw	$16, 0($18)
# was:	sw	_size_reg_18_, 0(_letBind_15_)
	addi	$20, $18, 4
# was:	addi	_res_reg_16_, _letBind_15_, 4
	ori	$19, $0, 0
# was:	ori	_ind_var_19_, 0, 0
_loop_beg_22_:
	sub	$3, $19, $16
# was:	sub	_tmp_reg_21_, _ind_var_19_, _size_reg_18_
	bgez	$3, _loop_end_23_
# was:	bgez	_tmp_reg_21_, _loop_end_23_
	lw	$3, 0($17)
# was:	lw	_tmp_reg_21_, 0(_inp_reg_17_)
# 	ori	2,_acc_reg_20_,0
# 	ori	3,_tmp_reg_21_,0
	jal	incr
# was:	jal	incr, 2 3
# 	ori	_tmp_reg_25_,2,0
# 	ori	_acc_reg_20_,_tmp_reg_25_,0
	sw	$2, 0($20)
# was:	sw	_acc_reg_20_, 0(_res_reg_16_)
	addi	$20, $20, 4
# was:	addi	_res_reg_16_, _res_reg_16_, 4
	addi	$17, $17, 4
# was:	addi	_inp_reg_17_, _inp_reg_17_, 4
	addi	$19, $19, 1
# was:	addi	_ind_var_19_, _ind_var_19_, 1
	j	_loop_beg_22_
_loop_end_23_:
	ori	$10, $18, 0
